...
<execution_context>
@E:/BRCONNECT/doces_mae/.claude/get-shit-done/workflows/settings-advanced.md
</execution_context>

<process>
**Follow the settings-advanced workflow** from `@E:/BRCONNECT/doces_mae/.claude/get-shit-done/workflows/settings-advanced.md`.
