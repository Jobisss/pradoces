...
Use template from `E:/BRCONNECT/doces_mae/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/BRCONNECT/doces_mae/.claude/get-shit-done/templates/UI-SPEC.md`
