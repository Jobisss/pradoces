...
<required_reading>
@E:/BRCONNECT/doces_mae/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@E:/BRCONNECT/doces_mae/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = E:/BRCONNECT/doces_mae/.claude
                  → checks E:/BRCONNECT/doces_mae/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = E:/BRCONNECT/doces_mae/.claude/get-shit-done
                  → writes to E:/BRCONNECT/doces_mae/.claude/get-shit-done/hooks/
...
@E:/BRCONNECT/doces_mae/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @E:/BRCONNECT/doces_mae/.claude/get-shit-done/references/common-bug-patterns.md
