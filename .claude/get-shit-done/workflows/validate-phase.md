...
```
Task(
  prompt="Read E:/BRCONNECT/doces_mae/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/BRCONNECT/doces_mae/.claude/get-shit-done/templates/VALIDATION.md`
