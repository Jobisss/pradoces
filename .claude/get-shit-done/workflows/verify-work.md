...
Read and follow `E:/BRCONNECT/doces_mae/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @E:/BRCONNECT/doces_mae/.claude/get-shit-done/workflows/diagnose-issues.md
