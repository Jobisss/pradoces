...
```bash
INIT=$(node "E:/BRCONNECT/doces_mae/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @E:/BRCONNECT/doces_mae/.claude/get-shit-done/templates/spec.md.
