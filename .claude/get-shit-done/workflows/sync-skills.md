...
INSTALL_JS_GLOBAL="E:/BRCONNECT/doces_mae/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node E:/BRCONNECT/doces_mae/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
