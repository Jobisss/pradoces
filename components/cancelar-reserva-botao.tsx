...
/** RES-09 — sem dialog "tem certeza": cancela otimista na hora, com 30s pra desfazer. */
export function CancelarReservaBotao({ reservaId }: { reservaId: string }) {
  ...
  useEffect(() => {
    return () => {
      ...
      if (timeoutRef.current) {
        ...
        void cancelarReserva(reservaId)
      }
    }
