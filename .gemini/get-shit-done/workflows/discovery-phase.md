...
See E:/BRCONNECT/doces_mae/.gemini/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using E:/BRCONNECT/doces_mae/.gemini/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using E:/BRCONNECT/doces_mae/.gemini/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from E:/BRCONNECT/doces_mae/.gemini/get-shit-done/templates/discovery.md
...
Use E:/BRCONNECT/doces_mae/.gemini/get-shit-done/templates/discovery.md.
