...
<required_reading>
@E:/BRCONNECT/doces_mae/.gemini/get-shit-done/references/ai-frameworks.md
@E:/BRCONNECT/doces_mae/.gemini/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read E:/BRCONNECT/doces_mae/.gemini/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "E:/BRCONNECT/doces_mae/.gemini/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read E:/BRCONNECT/doces_mae/.gemini/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read E:/BRCONNECT/doces_mae/.gemini/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read E:/BRCONNECT/doces_mae/.gemini/agents/gsd-eval-planner.md for instructions.
