...
```bash
INIT=$(node "E:/BRCONNECT/doces_mae/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @E:/BRCONNECT/doces_mae/.gemini/get-shit-done/templates/spec.md.
