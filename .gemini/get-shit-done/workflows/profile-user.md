...
Key references:
- @E:/BRCONNECT/doces_mae/.gemini/get-shit-done/references/ui-brand.md (display patterns)
- @E:/BRCONNECT/doces_mae/.gemini/agents/gsd-user-profiler.md (profiler agent definition)
- @E:/BRCONNECT/doces_mae/.gemini/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="E:/BRCONNECT/doces_mae/.gemini/get-shit-done/USER-PROFILE.md"
...
```bash
cp "E:/BRCONNECT/doces_mae/.gemini/get-shit-done/USER-PROFILE.md" "E:/BRCONNECT/doces_mae/.gemini/USER-PROFILE.backup.md"
```
...
✓ Stores profile at E:/BRCONNECT/doces_mae/.gemini/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `E:/BRCONNECT/doces_mae/.gemini/get-shit-done/references/user-profiling.md`
...
Reference: @E:/BRCONNECT/doces_mae/.gemini/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to E:/BRCONNECT/doces_mae/.gemini/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to E:/BRCONNECT/doces_mae/.gemini/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at E:/BRCONNECT/doces_mae/.gemini/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at E:/BRCONNECT/doces_mae/.gemini/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to E:/BRCONNECT/doces_mae/.gemini/CLAUDE.md"
...
```bash
BACKUP_PATH="E:/BRCONNECT/doces_mae/.gemini/USER-PROFILE.backup.md"
```
...
Your profile:    E:/BRCONNECT/doces_mae/.gemini/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   E:/BRCONNECT/doces_mae/.gemini/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        E:/BRCONNECT/doces_mae/.gemini/CLAUDE.md
```
