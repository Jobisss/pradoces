...
```
Task(
  prompt="Read E:/BRCONNECT/doces_mae/.gemini/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/BRCONNECT/doces_mae/.gemini/get-shit-done/templates/VALIDATION.md`
