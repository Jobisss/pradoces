...
```markdown
Read E:/BRCONNECT/doces_mae/.gemini/agents/gsd-ui-researcher.md for instructions.
...
Template: E:/BRCONNECT/doces_mae/.gemini/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read E:/BRCONNECT/doces_mae/.gemini/agents/gsd-ui-checker.md for instructions.
