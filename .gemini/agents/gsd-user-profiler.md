...
<reference>
@E:/BRCONNECT/doces_mae/.gemini/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/BRCONNECT/doces_mae/.gemini/get-shit-done/references/user-profiling.md` to load:
