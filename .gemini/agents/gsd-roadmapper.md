...
Reference full template: `E:/BRCONNECT/doces_mae/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/BRCONNECT/doces_mae/.gemini/get-shit-done/templates/state.md`.
